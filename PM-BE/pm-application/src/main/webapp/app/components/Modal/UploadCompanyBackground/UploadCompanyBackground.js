...
import { UploadAvatarStyle } from './upload-style';

import '../Modal';
import { commonStyles } from '../../../shared/styles/common-styles';
import patchPersonalProfile from '../../../api/patchPersonalProfile';
import postCompanyBackground from '../../../api/postCompanyBackground';
import global from '../../global';

class UploadCompanyBackground extends MaleficComponent {
    ...
    saveImage() {
        ...
        postCompanyBackground(this.id, formData)
            .then(res => {
                spinner.classList.remove('showSpinner');
                avtWrapper.classList.remove('loading');
                this.show = false;
                global.changeBgImage(res.secure_url);                  
            })
...
customElements.define('app-upload-company-background', UploadCompanyBackground);
