...
import com.company.pm.interactionservice.web.CompanyPostController;
...
@Component
public class CompanyPostRepresentationModelAssembler
    extends SimpleIdentifiableReactiveRepresentationModelAssembler<Post> {
    
    public CompanyPostRepresentationModelAssembler() {
        super(CompanyPostController.class);
    }
    ...
    protected WebFluxBuilder initLinkBuilder(ServerWebExchange exchange) {
        ...
        return linkTo(methodOn(CompanyPostController.class).getCompanyPosts(
